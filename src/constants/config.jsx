    ...
    items: [
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.CancerCareIcon}
            alt="Cancer Care / Oncology"
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.CardiacSciencesIcon}
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.GastroenterologyIcon}
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.LiverTransplantIcon}
            alt="Liver Transplant and Biliary Sciences"
            className="w-4 h-4 object-contain"
          />
        ),
        href: '#specialties'
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.OrthopaedicsIcon}
            alt="Orthopaedics & Joint Replacement"
            className="w-4 h-4 object-contain"
          />
        ),
        href: '#specialties'
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.RenalSciencesIcon}
            alt="Renal Sciences"
            className="w-4 h-4 object-contain"
          />
        ),
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.NeurosciencesIcon}
            alt="Neurosciences"
            className="w-4 h-4 object-contain"
          />
        ),
    ...
    items: [
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.BoneMarrowIcon}
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.BariatricSurgeryIcon}
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.ClinicalPsychologyIcon}
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.RheumatologyIcon}
            alt="Rheumatology"
            className="w-4 h-4 object-contain"
          />
        ),
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.DiabeticFootIcon}
            alt="Diabetic Foot"
            className="w-4 h-4 object-contain"
          />
        ),
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.DentalIcon}
            alt="Dental"
            className="w-4 h-4 object-contain"
          />
        ),
      ...
      },
      {
        ...
        icon: (
          <img
            src={IMAGES.menusIcon.DermatologyIcon}
            alt="Dermatology"
            className="w-4 h-4 object-contain"
          />
        ),
...
export const HOSPITALS_DATA = [
  ...
  },
  {
    ...
    image: IMAGES.hospitals.gurugram,
  ...
  },
  {
    ...
    image: IMAGES.hospitals.vadodara,
  ...
  },
  {
    ...
    image: IMAGES.hospitals.saudiArabia,
