...
const hospital_urls = {
  "Marengo CIMS Hospital, Ahmedabad": "https://marengoasiahospitals.com/hospital/marengo-cims-hospital-ahmedabad",
  "Marengo Asia Hospitals, Gurugram": "https://marengoasiahospitals.com/hospital/marengo-asia-hospitals-gurugram",
  "Marengo Asia Hospitals, Faridabad": "https://marengoasiahospitals.com/hospital/marengo-asia-hospital-faridabad",
  "Marengo Asia Hospital, Surat": "https://marengoasiahospitals.com/hospital/sunshine-global-marengo-asia-hospital",
  "Marengo Asia Hospital, Vadodara": "https://marengoasiahospitals.com/hospital/sunshine-global-hospital-vadodara",
  "Marengo Asia Hospital, Saudi Arabia": "https://marengoasiahospitals.com/hospital/specialized-najran-hospital",
};
        ...
        <div className="fixed inset-0 z-[150] overflow-hidden">
          ...
          >
            ...
            <div className="px-5 py-4 flex items-center justify-between border-b border-slate-100 bg-white">
              <a href="https://marengoasiahospitals.com/" onClick={onClose} className="flex items-center">
                <img
            ...
            <div className="flex-1 overflow-y-auto py-3 px-4 space-y-1.5 scrollbar-thin">
              {HEADER_NAV_ITEMS.map((item) => {
                if (item.dropdownType === 'hospitals') {
                  return (
                          ...
                          >
                            {HOSPITALS_DATA.map((h) => (
                              <a
                                key={h.id}
                                href={
                                  hospital_urls[h.name] || "https://marengoasiahospitals.com/"
                                }
                                onClick={onClose}
                ...
                if (item.dropdownType === 'specialties') {
                  return (
                    <motion.div key={item.label} variants={itemVariants}>
                      <button
                ...
                return (
                  <motion.div key={item.label} variants={itemVariants}>
                    ...
                    >
                      <NavIcon className="w-4 h-4 text-[#005BAA] group-hover:scale-110 transition-transform" />
                      <span>{item.label}</span>
                    </a>
                  </motion.div>
                );
              ...
              <motion.div variants={itemVariants} className="pt-3 mt-3 border-t border-slate-100 space-y-1 text-xs">
                ...
                <a
                  href="https://marengoasiahospitals.com/career"
                  onClick={onClose}
                  className="flex items-center gap-2.5 py-2 px-3 text-slate-600 hover:text-[#005BAA] hover:bg-slate-50 rounded-lg transition-colors"
                >
            ...
            <div className="p-4 sm:p-5 border-t border-slate-100 bg-slate-50 space-y-3">
              <a
                ...
                onClick={onClose}
                className="w-full inline-flex items-center justify-center gap-2 bg-[#F37023] hover:bg-[#D95F16] text-white font-bold shadow-md shadow-orange-500/20 py-3 px-4 rounded-lg transition-colors"
              >
